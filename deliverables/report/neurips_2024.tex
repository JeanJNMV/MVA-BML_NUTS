...
Some components are only briefly sketched in the original paper, so we provide more detailed derivations here. We focus on the two key theoretical ingredients ensuring correctness of NUTS: the uniform distribution over the candidate set $\mathcal{C}$ and the memory-efficient transition kernel.
